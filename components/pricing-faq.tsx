...
const pricingFaqData = [
  {
    id: "item-1",
    question: "How does pilechat's AI improve the real estate listing process?",
    answer:
      "pilechat utilizes AI to analyze property details and generate compelling descriptions that highlight unique features, optimize for search engines, and attract potential buyers more effectively than standard listings.",
  },
  {
    id: "item-2",
    question: "Can I integrate pilechat with my existing real estate tools?",
    answer:
      "Not yet... But soon we can say this - Absolutely! pilechat is built with integration in mind. Our comprehensive API allows you to seamlessly connect with a range of real estate tools and platforms, ensuring a smooth addition to your current workflow.",
  },
  {
    id: "item-3",
    question: "What kind of support can I expect with pilechat?",
    answer:
  ...
  {
    id: "item-4",
    question: "Is my data secure with pilechat?",
    answer:
